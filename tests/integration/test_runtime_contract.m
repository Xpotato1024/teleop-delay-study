...
canonicalTime = simulationOutput.yout.getElement('zoh_command_xy_m').Values.Time;
for name = names
    signalTime = simulationOutput.yout.getElement(name{1}).Values.Time;
    verifyEqual(testCase, signalTime, canonicalTime, AbsTol=0);
end
