function representatives = select_representatives(input, classification, config) %#ok<INUSD>
...
for trajectoryName = trajectoryNames
    ...
    if trajectoryName == "lissajous_1_2"
        ...
        eventText = "direction-change/high-acceleration diagnostic; peak acceleration=" + ...
